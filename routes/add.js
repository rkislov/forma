...
router.post('/',auth,  async (req,res)=> {
    ...
    if(!errors.isEmpty()){
        return res.status(422).render('add', {
            ...
            data: {
                ...
                price: req.body.pricenum.replace(/,/g, '.'),
                full_price: req.body.pricenum.replace(/,/g, '.')*req.body.colichestvo,
                celi: req.body.celi,
    ...
    const record = new Record({
        ...
        object: req.body.object,
        colichestvo: req.body.colichestvo,
        price: req.body.pricereq.body.pricenum.replace(/,/g, '.'),
        full_price: req.body.pricereq.body.pricenum.replace(/,/g, '.')*req.body.colichestvo,
        celi: req.body.celi,
        marki: req.body.marki,
        analiz: req.body.analiz,
        name_kontragent: req.body.name_kontragent,
